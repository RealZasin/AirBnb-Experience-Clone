  ...
  return (
    <div>
      <div className={styles.Japan}>
        <img src="../../../public/Japan.jpg" className={styles.JapanIMG} />
        <h3>Japan</h3>
        <h1>Mount Fuji</h1>
      </div>
      <div className={styles.Maldives}>
        <img src="../../../public/Maldivene.jpg" className={styles.MaldivesIMG} />
        <h3>Maldives</h3>
        <h1>Male</h1>
      </div>
      <div className={styles.Dubai}>
        <img src="../../../public/dubai-palm-jumeirah-island.jpg" className={styles.DubaiIMG} />
        <h3>Dubai</h3>
        <h1>Burj Khalifa</h1>
      </div>
    </div>
